...
class PullRequestMetricID(Model, metaclass=Enum):
    ...
    PR_CYCLE_TIME_BELOW_THRESHOLD_RATIO = "pr-cycle-time-below-threshold-ratio"
    ...
    PR_LIVE_CYCLE_TIME = "pr-live-cycle-time"
    PR_LIVE_CYCLE_COUNT = "pr-live-cycle-count"
    PR_LIVE_CYCLE_COUNT_Q = "pr-live-cycle-count-q"
    PR_ALL_COUNT = "pr-all-count"
    PR_FLOW_RATIO = "pr-flow-ratio"
    PR_OPENED = "pr-opened"
    PR_REVIEWED = "pr-reviewed"
    PR_REVIEWED_CLOSED = "pr-reviewed-closed"
