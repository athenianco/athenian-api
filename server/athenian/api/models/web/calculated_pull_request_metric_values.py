...
class CalculatedPullRequestMetricValues(Model):
    ...
    def __init__(self, date: Optional[datetime.date] = None,
        ...
        """Initialize CalculatedPullRequestMetricValues - a model defined in OpenAPI.
    ...
    def date(self) -> datetime.date:
        """Gets the date of this CalculatedPullRequestMetricValues.

        Where you should relate the metric value to on the time axis.

        :return: The date of this CalculatedPullRequestMetricValues.
        """
        return self._date

    @date.setter
    def date(self, date: datetime.date):
        """Sets the date of this CalculatedPullRequestMetricValues.
    ...
    def values(self) -> List[object]:
        """Gets the values of this CalculatedPullRequestMetricValues.

        The same order as `metrics`.

        :return: The values of this CalculatedPullRequestMetricValues.
        """
        return self._values

    @values.setter
    def values(self, values: List[object]):
        """Sets the values of this CalculatedPullRequestMetricValues.
