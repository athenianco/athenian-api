...
class RepoName:
    ...
    @classmethod
    def from_prefixed(cls, prefixed_name: str) -> RepoName:
        ...
        if "/" in rest:
            ...
            physical = rest
            logical = None
        return RepoName(prefix, org, physical, logical)
    ...
    def with_logical(self, logical: Optional[str]) -> RepoName:
    ...
    def unprefixed_physical(self) -> str:
        ...
        return f"{self.organization}/{self.physical}"
