...
async def _fill_issues_with_mapped_prs_info(
    ...
    issues[ISSUE_RESOLVED] = issues[ISSUE_RESOLVED].astype(issues[ISSUE_CREATED].dtype)
...
async def _query_jira_raw_by_keys(
    ...
    return await read_sql_query(stmt, mdb, columns, index=Issue.id.name)
