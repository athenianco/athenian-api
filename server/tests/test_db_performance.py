...
from athenian.api.models.metadata.github import NodePullRequest, NodePullRequestCommit, \
...
def _benchmark(conn: PostgresConnection) -> None:
    ...
    conn._compile(
        select([NodePullRequest.id, NodePullRequest.author_id, NodePullRequest.merged,
