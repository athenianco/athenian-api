...
async def test_mine_deployments_only_failed(
    release_match_setting_tag_or_branch, branches, default_branches, prefixer, mdb, pdb, rdb, cache
):
...
async def test_mine_deployments_logical(
    ...
    for deployment_name, components, releases in zip(
        deps.index.values, deps["components"].values, deps["releases"].values
    ):
...
async def test_mine_deployments_no_release_facts(
    ...
    assert obj == {
        ...
        "prs_additions": {
            ...
            (41483, "src-d/go-git"): [83, 484, 3, 32, 2, 725, 132, 45, 8, 49, 178, 2949, 276, 831],
            ...
            (41512, "src-d/go-git"): [56, 15, 69, 7, 35, 25, 35, 6, 24, 198, 37, 189, 11, 758],
            (41511, "src-d/go-git"): [
                22,
                117,
                68,
        ...
        "prs_deletions": {
            ...
            (41483, "src-d/go-git"): [0, 387, 2, 6, 1, 173, 32, 18, 3, 135, 7, 1539, 53, 47],
            ...
            (41512, "src-d/go-git"): [115, 14, 25, 5, 7, 31, 1, 6, 1, 27, 15, 39, 11, 0],
            (41511, "src-d/go-git"): [
                6,
                0,
                0,
...
async def test_mine_deployments_precomputed_dummy(
    release_match_setting_tag_or_branch, branches, default_branches, prefixer, mdb, pdb, rdb
):
    time_from = datetime(2015, 1, 1, tzinfo=timezone.utc)
    time_to = datetime(2020, 1, 1, tzinfo=timezone.utc)
...
async def test_mine_release_by_name_deployments(
    release_match_setting_tag_or_branch, prefixer, precomputed_deployments, mdb, pdb, rdb
):
