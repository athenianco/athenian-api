...
@pytest.mark.parametrize(
    "with_memcached, with_mine_cache_wipe", itertools.product(*([[False, True]] * 2))
)
@with_defer
                ...
                [  # repository group 1
                    [  # participants group 1
                        ...
                        [  # time series primary 2
                            [
                                metric(
                                    exists=True, value=65, confidence_min=None, confidence_max=None
                                ),
                                metric(
                                    exists=True, value=62, confidence_min=None, confidence_max=None
                                ),
                                metric(
                                    exists=True, value=54, confidence_min=None, confidence_max=None
                                ),
                            ],
                            [
                                metric(
                                    exists=True, value=69, confidence_min=None, confidence_max=None
                                ),
                                metric(
                                    exists=True, value=69, confidence_min=None, confidence_max=None
                                ),
                                metric(
                                    exists=True, value=56, confidence_min=None, confidence_max=None
                                ),
                            ],
                        ],
                    ],
                    ...
                    [  # participants group 1
                        ...
                        [  # time series primary 2
                            [
                                ...
                                metric(
                                    exists=True, value=70, confidence_min=None, confidence_max=None
                                ),
                                metric(
                                    exists=True, value=64, confidence_min=None, confidence_max=None
                                ),
                            ],
                            [
                                metric(
                                    exists=True, value=73, confidence_min=None, confidence_max=None
                                ),
                                metric(
                                    exists=True, value=72, confidence_min=None, confidence_max=None
                                ),
                                metric(
                                    exists=True, value=66, confidence_min=None, confidence_max=None
                                ),
                            ],
                        ],
                    ],
...
async def test_calc_pull_request_facts_github_jira(
    metrics_calculator_factory, mdb, pdb, rdb, release_match_setting_tag, prefixer, bots, cache
):
    metrics_calculator = metrics_calculator_factory(1, (6366825,), with_cache=True)
...
async def test_calc_pull_request_facts_github_event_releases(
    metrics_calculator_factory, mdb, pdb, rdb, release_match_setting_event, prefixer, bots, cache
):
    await rdb.execute(
...
async def real_pr_samples(
    release_match_setting_tag, metrics_calculator_factory, prefixer, bots
