...
class TestChangeFailureMetrics(BaseCalcMetricsDeploymentsTest):
    async def test_base(self, mdb_rw: Database, rdb: Database, sdb: Database) -> None:
        ...
        await models_insert(
            ...
            DeplLabelFact(deployment_name="d2", key=CHANGE_FAILURE_LABEL, value=None),
            ...
            DeplLabelFact(deployment_name="d3", key=CHANGE_FAILURE_LABEL, value=["DEV-123"]),
            ...
            DeplLabelFact(deployment_name="d4", key=CHANGE_FAILURE_LABEL, value=True),
            DeplFact(name="d5", finished_at=dt(2005, 2, 1), started_at=dt(2005, 1, 1)),
            DeplCompFact(deployment_name="d5", repository_node_id=9, resolved_commit_node_id=5),
            DeplFact(
                name="d6",
            ...
            DeplCompFact(deployment_name="d6", repository_node_id=9, resolved_commit_node_id=6),
        )
